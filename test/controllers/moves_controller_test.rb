...
class MovesControllerTest < ActionController::TestCase
  ...
  test "should create move" do
    assert_difference('Move.count') do
      post :create, move: { game_id: @move.game_id, player_id: @move.player_id, square: @move.square, symbol: @move.symbol }
    end
  ...
  test "should update move" do
    patch :update, id: @move, move: { game_id: @move.game_id, player_id: @move.player_id, square: @move.square, symbol: @move.symbol }
    assert_redirected_to move_path(assigns(:move))
  end
